...
let AuthService = class AuthService {
    ...
    async login(dto, ip) {
        ...
        if (intentoBloqueo) {
            throw new ForbiddenException('Tu cuenta está bloqueada hasta ' + intentoBloqueo.bloqueado_hasta.toLocaleString('es-CL'));
        }
    ...
    async crearUsuario(dto, creadorId) {
    ...
    async registrarIntentoFallido(id_empresa, ip, rut_intentado) {
